...
function Pivot(rawData,columnX,columnY_List,sortX_Asc,sortY_Asc,Calfunc,CalCol)
{
  ...
  for(let i=0; i < pivot_list.length; i++)
  {
    ...
    //push total numbers add later
    //CellRow.push(null); ///////not valid yet -- calculate later base on all other cell value
...
let pivot_tbl = Pivot(sourceData,"",["",""],false,false);
